...
public class PlayerJumpAttack6 : PlayerCombatBaseState
{
    public PlayerJumpAttack6(PlayerCombatStateMachine stateMachine, PlayerCombatStateFactory factory) : base(stateMachine, factory) { }
    public override void EnterState()
    {
        playerManager.playerAnimationManager.PlayActionAnimation(
            animationName: "JumpAttack6",
    ...
    {
        foreach (CombatScriptableObj criteria in factory.stateList[PlayerCombatState.JumpAttack6].stateInformation.nextStates)
        {
