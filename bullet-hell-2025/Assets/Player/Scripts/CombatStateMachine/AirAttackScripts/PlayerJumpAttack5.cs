...
public class PlayerJumpAttack5 : PlayerCombatBaseState
{
    public PlayerJumpAttack5(PlayerCombatStateMachine stateMachine, PlayerCombatStateFactory factory) : base(stateMachine, factory) { }
    public override void EnterState()
    {
        playerManager.playerAnimationManager.PlayActionAnimation(
            animationName: "JumpAttack5",
    ...
    {
        foreach (CombatScriptableObj criteria in factory.stateList[PlayerCombatState.JumpAttack5].stateInformation.nextStates)
        {
