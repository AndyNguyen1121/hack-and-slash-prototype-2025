...
public class PlayerJumpAttack4 : PlayerCombatBaseState
{
    public PlayerJumpAttack4(PlayerCombatStateMachine stateMachine, PlayerCombatStateFactory factory) : base(stateMachine, factory) { }
    public override void EnterState()
    {
        playerManager.playerAnimationManager.PlayActionAnimation(
            animationName: "JumpAttack4",
    ...
    {
        foreach (CombatScriptableObj criteria in factory.stateList[PlayerCombatState.JumpAttack4].stateInformation.nextStates)
        {
