...
public class WaveManager : MonoBehaviour
{
    ...
    {
        await Task.Delay((int)(restDuration * 1000));
        ...
        while (numEnemiesSpawnDuringThisWave < maxNumEnemies)
        {
            ...
            IDamageable healthScript = enemy.GetComponentInChildren<IDamageable>();    
            if (healthScript != null)
            {
                healthScript.MaxHealth *= healthMultiplier;
                healthScript.SetHealthValue(healthScript.MaxHealth);
            }

            // set damage multipler
            EnemyCombatManager damageScript = enemy.GetComponentInChildren<EnemyCombatManager>();
